...
public class ConfigParser {
    ...
    private void checkinlinefile(Vector<String> args, BufferedReader br) throws IOException, ConfigParseError {
        ...
        if (arg0.startsWith("<") && arg0.endsWith(">")) {
            ...
            // Normalize: remove leading/trailing empty lines often added by parsers or manual edits
            String content = inlinefile.substring(VpnProfile.INLINE_TAG.length());
            content = content.trim();
            inlinefile = VpnProfile.INLINE_TAG + content;
